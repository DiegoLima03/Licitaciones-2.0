            ...
            <main>
                <div class="card">
                    ...
                    <p>
                        ...
                        conectaremos al backend PHP para guardar en <code>tbl_licitaciones</code>.
                    </p>
                    ...
                    <form>
                        ...
                        <div class="actions">
                            <button type="button" class="btn-secondary" onclick="window.location.href='licitaciones.php'">
                                Cancelar
                            </button>
