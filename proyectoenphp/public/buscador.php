    ...
    <div class="layout">
        <aside class="sidebar">
            ...
            <nav class="sidebar-nav">
                ...
                <a href="buscador.php" class="nav-link active">Buscador historico</a>
        ...
        <div class="main">
            <header>
                <h1>Buscador historico de precios</h1>
                <div class="user-info">
            ...
            <main>
                <div class="card">
                    <h2>Buscador historico de precios</h2>
                    <p>
                        Aqui podras buscar productos y ver su historico de precios
                        a partir de las licitaciones y las lineas de referencia.
                        Mas adelante conectaremos este buscador con la logica PHP y MySQL.
                    </p>
                    <div class="search-row">
                        <input type="text" placeholder="Ej: Planta, Tierra, Tuberia..." />
                        <button type="button">Buscar</button>
                    </div>
                    <p class="hint">
                        (De momento es solo un buscador visual. La consulta real al historico
                        la haremos contra las tablas MySQL con PHP.)
                    </p>
                </div>
            </main>
        </div>
